...
# 旅行関連のサンプルデータ
DESTINATIONS = [
    "東京", "京都", "大阪", "北海道", "沖縄", "福岡", "広島", "金沢", "鎌倉", "箱根",
    "パリ", "ロンドン", "ニューヨーク", "ローマ", "バルセロナ", "シンガポール", "バンコク",
    "ソウル", "台北", "香港", "バリ島", "ハワイ", "グアム", "プーケット", "ドバイ"
]

ACTIVITIES = [
    "温泉巡り", "グルメツアー", "街歩き", "美術館巡り", "ショッピング", "寺社仏閣巡り",
    "自然散策", "登山", "ビーチリゾート", "ナイトマーケット探索", "絶景スポット巡り",
    "歴史的建造物見学", "カフェ巡り", "フォトジェニックスポット巡り", "クルーズ",
    "アクティビティ体験", "現地料理体験", "文化体験", "リラクゼーション", "絶景ドライブ"
]

THEMES = [
    "家族旅行", "一人旅", "カップル旅行", "女子旅", "卒業旅行", "新婚旅行", "週末旅行",
    "長期滞在", "弾丸旅行", "ワーケーション", "癒しの旅", "冒険の旅", "グルメ旅",
    "歴史探訪", "アート巡り", "自然満喫", "リゾート旅行", "ビジネス＋観光"
]

SEASONS = [
    "春の", "夏の", "秋の", "冬の", "桜の季節の", "紅葉シーズンの",
    "ゴールデンウィークの", "年末年始の", "夏休みの", "シルバーウィークの"
]
...
def insert_test_data():
    ...
    # 旅行関連のサマリを生成
    data = {
        'summary': [generate_travel_summary() for _ in range(NUM_RECORDS)]
    }
